...
author: |
  ...
  | <small>Presentation at Gemelli generator - 2022-01-14</small>
output:
  revealjs::revealjs_presentation:
    template: 2022_01_14_Gemelli_Generator_Template.html
    incremental: false
...
## Data Emission Estimation and Mortatility in the Ciampino Municipality and sourrounding (2006-2007) {data-background="img/copertina.jpg" data-background-size="17%" data-background-position="0% 0%"}
...
<small>
 ...
 - <span style="background-color:rgba(0,0,0,0.9)"> A brand new test in allergology $->$ definition of appropriate statistical analisys and new (in allergology) paradigms of visualization </span>
    ...
    + <span style="background-color:rgba(0,0,0,0.9)"> Recently, Advisor for a Master Thesys in Statistics</span>  
...
<small>
 ...
 - <span style="background-color:rgba(0,0,0,0.9)"> More details on  </span>
    ...
    + <span style="background-color:rgba(0,0,0,0.9)"> GRASPA 2019 Conference, Pescara, 15-16 July 2019</span>
...
- <span style="background-color:rgba(0,0,0,0.7)"> On the Italian network of Industrial Mathematics and its future developments: Sportello Matematico per l’industria italiana. European Consortium for Mathematics in Industry, 173-178 </span>  
...
# <span style="background-color:rgba(0,0,0,0.5)"> The Present (2016-Today) </span>  {data-background="img/The_Present.JPG" data-background-size="contain" data-background-repeat="no-repeat"}

## Natural Language Processing

- Use of models like **Topic Model**, **Word Embeddings** and **Transformers** in order to:  
    ...
    + Evaluate sentiment polarity and emotions
...
## <span style="background-color:rgba(0,0,0,0.5)">Semanticase </span> {data-background-image="img/Semanticase.png" data-background-size="contain"}

- <span style="background-color:rgba(0,0,0,0.5)">All the experiences in NLP was embedded and developed in  [semanticase.it](https://semanticase.it)</span>

## <span style="background-color:rgba(0,0,0,0.5)"> </span> {data-background-image="img/Enel_Panorama.png" data-background-size="contain"}

<span style="background-color:rgba(0,0,0,0.5)"> One of the most succefull application of Semamticase is on customer care</span>
...
- The work as be accepted on CRAN and published on Journal of Statistical Computation and Simulation 90 (7), 1315-1345

- http://santoroma.github.io/CircSpaceTime/
...
## <span style="background-color:rgba(0,0,0,0.5)">Gemelli Generator </span> {data-background-image="img/Start_Project.gif"}
